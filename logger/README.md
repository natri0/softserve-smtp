...
A high-performance asynchronous logging library implemented in C++20 with thread-safe operations and lock-free queues.
...
- `LogLevel::ERROR`: Error messages for critical failures

### Environment Types

- `TRACE`: Development/debugging environment
